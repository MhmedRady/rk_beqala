            ...
            <?php if(Route::has('login')): ?>
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(url('/home')); ?>" class="text-sm text-gray-700 underline">Dashboard</a>
                    <?php else: ?>
...
<?php /**PATH /home/ghost/Development/htdocs/beqala/resources/views/welcome.blade.php ENDPATH**/ ?>